...
from jtttestserver.jt_client_parser.client_obj.client_msg import Jt808ClientMsgInfo
...
class JT808ClientMessageParser:
    ...
    def parser(cls, data: bytes):
        ...
        """
        # 数据转义解码
        data = FunctionTools.de_escape(data)
        ...
        # 消息体 解析
        data_body = Jt808ClientMsgBodyRegister.parser_msg_body(msg_id, data_body_bytes)
        ...
        # 组装
        client_msg_info = Jt808ClientMsgInfo(
            sign_byte_head=sign_byte_head,
            header=header_info,
            data_body=data_body,
            check_byte=check_byte,
            sign_byte_tail=sign_byte_tail,
        )
        return client_msg_info
